    ...
    return (
        <FormContainer>
            ...
            　　<Form.Group controlId="name">
                    ...
                    <Form.Control type='name' placeholder='名前（匿名可）' value={name} onChange={(e) => setName(e.target.value)}></Form.Control>
                </Form.Group>
                ...
                <Form.Group controlId="confirmpassword">
                    ...
                    <Form.Control type='password' placeholder='確認パスワード' value={confirmPassword} onChange={(e) => setConfirmPassword(e.target.value)}></Form.Control>
                </Form.Group>
            ...
            <Row className='py-3'>
                <Col>
                   アカウントをお持ちですか？　<Link to={redirect ? `/login?redirect=${redirect}` : '/login'}>ログイン</Link>
                </Col>
            </Row>
        </FormContainer>
    )
